...
class AppForm(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.lpar = np.asarray([(st_x1*dpl + x1_min),
                                (st_x2*dpl + x2_min),
                                st_re*re_max/nbins, st_rc*0.0,
                                st_ql*ql_max/nbins, st_la*la_max/nbins])
        self.spar = np.asarray([(st_y1*dps + y1_min),
                                (st_y2*dps + y2_min),
                                st_rh*rh_max/nbins, st_sa+1.0,
                                st_qs*qs_max/nbins, st_sa*sa_max/nbins])
        ...
        self.view_gsrc = self.canvas.addViewBox()
        self.view_gsrc.setAspectLocked(True)

        self.view_limg = self.canvas.addViewBox()
        self.view_limg.setAspectLocked(True)

        # self.view.setRange(QtCore.QRectF(-10,-10, 10, 10))

        self.img_gsrc = pg.ImageItem(border='w')
        # self.img_gsrc_ctr = pg.IsocurveItem(level=[0.5])

        self.img_limg = pg.ImageItem(border='w')
        # self.img_limg_ctr = pg.IsocurveItem(level=[0.5])

        self.on_draw()

        # pg.mkPen('y', width=3)

        self.view_gsrc.addItem(self.img_gsrc)
        self.view_limg.addItem(self.img_limg)

        # self.view_gsrc.addItem(self.img_gsrc_ctr)
        # self.view_limg.addItem(self.img_limg_ctr)
        #-------------------------------------------------------------
        # Add decorations
        #
    ...
    def on_draw(self):
        ...
        #----------------------------------------------------------------------
        self.g_limage,self.g_source,mua,yi1,yi2 = ll.lensed_images(self.xi1,self.xi2,self.lpar,self.spar)
        ...
        # self.img_gsrc_ctr.setData(self.g_source)
        # self.img_limg_ctr.setData(self.g_limage)
        # #--------------------------lens images contour------------------------
...
#-------
    ...
    def create_main_frame(self):
        ...
        self.cb_cosmo = QtWidgets.QComboBox()
...
#-------
        self.slider_label_re = QtWidgets.QLabel("Re")
        self.slider_re = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_re.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_re = QtWidgets.QDoubleSpinBox()
        self.sbox_re.setSingleStep(re_max/nsbox)
        self.sbox_re.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_x1 = QtWidgets.QLabel("x1")
        self.slider_x1 = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_x1.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_x1 = QtWidgets.QDoubleSpinBox()
        self.sbox_x1.setSingleStep((x1_max-x1_min)/nsbox)
        self.sbox_x1.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_x2 = QtWidgets.QLabel("x2")
        self.slider_x2 = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_x2.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_x2 = QtWidgets.QDoubleSpinBox()
        self.sbox_x2.setSingleStep((x2_max-x2_min)/nsbox)
        self.sbox_x2.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_ql = QtWidgets.QLabel("ql")
        self.slider_ql = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_ql.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_ql = QtWidgets.QDoubleSpinBox()
        self.sbox_ql.setSingleStep(ql_max/nsbox)
        self.sbox_ql.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_la = QtWidgets.QLabel("la")
        self.slider_la = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_la.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_la = QtWidgets.QDoubleSpinBox()
        self.sbox_la.setSingleStep(la_max/nsbox)
        self.sbox_la.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_rh = QtWidgets.QLabel("Rh")
        self.slider_rh = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_rh.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_rh = QtWidgets.QDoubleSpinBox()
        self.sbox_rh.setSingleStep(rh_max/nsbox)
        self.sbox_rh.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_y1 = QtWidgets.QLabel("y1")
        self.slider_y1 = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_y1.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_y1 = QtWidgets.QDoubleSpinBox()
        self.sbox_y1.setSingleStep((y1_max-y1_min)/nsbox)
        self.sbox_y1.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_y2 = QtWidgets.QLabel("y2")
        self.slider_y2 = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_y2.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_y2 = QtWidgets.QDoubleSpinBox()
        self.sbox_y2.setSingleStep((y2_max-y2_min)/nsbox)
        self.sbox_y2.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_qs = QtWidgets.QLabel("qs")
        self.slider_qs = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_qs.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_qs = QtWidgets.QDoubleSpinBox()
        self.sbox_qs.setSingleStep(qs_max/nsbox)
        self.sbox_qs.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
        self.slider_label_sa = QtWidgets.QLabel("sa")
        self.slider_sa = QtWidgets.QSlider(QtCore.Qt.Horizontal)
        self.slider_sa.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.sbox_sa = QtWidgets.QDoubleSpinBox()
        self.sbox_sa.setSingleStep(sa_max/nsbox)
        self.sbox_sa.setFocusPolicy(QtCore.Qt.StrongFocus)
...
#-------
    ...
    def create_status_bar(self):
        self.status_text = QtWidgets.QLabel("This is a statusbar")
