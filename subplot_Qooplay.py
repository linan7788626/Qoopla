...
class AppForm(QMainWindow):
    ...
    def on_draw(self):
        ...
        self.ax1.cla()
        # self.ax1.set_xlim(y1_min,y1_max)
        # self.ax1.set_ylim(y2_min,y2_max)
        # self.ax1.set_xticks([ybc1-0.4, ybc1-0.2, ybc1, ybc1+0.2, ybc1+0.4])
        # self.ax1.set_yticks([ybc2-0.4, ybc2-0.2, ybc2, ybc2+0.2, ybc2+0.4])
        # self.axesa.contourf(self.xi1,self.xi2,self.sgals,levels_imgs,cmap=pl.cm.gray)
        self.ax1.contour(self.xi1,self.xi2,g_source,levels,colors=('deepskyblue'))
        # self.ax1.contour(yi1,yi2,mua,0,colors=('r'),linewidths = 2.0)

        self.ax2.cla()
        # self.ax2.set_xlim(x1_min,x1_max)
        # self.ax2.set_ylim(x2_min,x2_max)
        # self.ax2.set_xticks([xbc1-2, xbc1-1, xbc1, xbc1+1, xbc1+2])
        # self.ax2.set_yticks([xbc2-2, xbc2-1, xbc2, xbc2+1, xbc2+2])
        # self.ax2.contourf(self.xi1,self.xi2,self.lgals,levels_imgs,cmap=pl.cm.gray)
        self.ax2.contour(self.xi1,self.xi2,g_limage,levels,colors=('deepskyblue'))
        # self.ax2.contour(self.xi1,self.xi2,mua,colors=('r'),linewidths = 2.0)
...
#-------
    ...
    def optimization_actions(self):
        ...
        self.ax2.set_xlim(x1_min,x1_max)
        self.ax2.set_ylim(x2_min,x2_max)
        self.ax2.set_xticks([xbc1-2.0,xbc1-1.0,xbc1,xbc1+1.0,xbc1+2.0])
        self.ax2.set_yticks([xbc2-2.0,xbc2-1.0,xbc2,xbc2+1.0,xbc2+2.0])
        self.ax2.contourf(self.xi1,self.xi2,self.lgals,levels_imgs,cmap=pl.cm.gray)
        self.ax2.contour(self.xi1,self.xi2,g_limage,levels,colors=('deepskyblue'))
        self.ax2.contour(self.xi1,self.xi2,mua,colors=('r'),linewidths = 2.0)
