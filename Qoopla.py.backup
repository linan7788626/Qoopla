...
class AppForm(QMainWindow):
    ...
    def on_draw(self):
        ...
        l_xcen = self.slider_x1.value()*self.bsz/nbins-self.bsz/2.0   	# x position of center (also try (0.0,0.14)
        l_ycen = self.slider_x2.value()*self.bsz/nbins-self.bsz/2.0  	# y position of center
        l_re = self.slider_re.value()*4.0/nbins   # Einstein radius of lens.
        ...
        g_xcen =  self.slider_y1.value()*self.bsz/nbins-self.bsz/2.0  	# x position of center (also try (0.0,0.14)
        g_ycen =  self.slider_y2.value()*self.bsz/nbins-self.bsz/2.0  	# y position of center
        ...
        self.axesa.clear()
        self.axesa.set_xlim(-self.bsz/2.0,self.bsz/2.0)
        self.axesa.set_ylim(-self.bsz/2.0,self.bsz/2.0)
        self.axesa.contour(self.xi1,self.xi2,g_source,levels,colors=('b'))
    ...
    def optimization_actions(self):
        ...
        self.slider_re.setValue(int(lpar_new[2]/4.0*nbins))
        self.slider_x1.setValue(int((lpar_new[0]+self.bsz/2.0)/self.bsz*nbins))
        self.slider_x2.setValue(int((lpar_new[1]+self.bsz/2.0)/self.bsz*nbins))
        self.slider_ql.setValue(int(lpar_new[4]*nbins))
        self.slider_la.setValue(int(lpar_new[5]/360.0*nbins))

        self.slider_rh.setValue(int(spar_new[2]/0.5*nbins))
        self.slider_y1.setValue(int((spar_new[0]+self.bsz/2.0)/self.bsz*nbins))
        self.slider_y2.setValue(int((spar_new[1]+self.bsz/2.0)/self.bsz*nbins))
        self.slider_qs.setValue(int(spar_new[4]*nbins))
        self.slider_sa.setValue(int(spar_new[5]/360.0*nbins))
