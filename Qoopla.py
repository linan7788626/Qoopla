...
#-------
        ...
        for w in [self.sbox_label_h0, self.sbox_h0, self.sbox_label_om, self.sbox_om, self.sbox_label_ol, self.sbox_ol, self.cb_cosmo, self.cb_models, self.cb_codes, self.draw_button]:
